...
public class DashboardPage extends BasePage {
    ...
    @FindBy(xpath = "//h6[normalize-space()='The Treasure']")
    private WebElement treasureElement;

    @FindBy(xpath = "//h6[normalize-space()='Total Products']")
    private WebElement totalProductElement;

    @FindBy(xpath = "//h6[normalize-space()='Total Sales']")
    private WebElement totalSalesElement;

    @FindBy(xpath = "//h6[normalize-space()='Total Orders']")
    private WebElement totalOrdersElement;

    @FindBy(xpath = "//h4[normalize-space()='Top Products']")
    ...
    @FindBy(xpath = "//h4[normalize-space()='Orders']")
