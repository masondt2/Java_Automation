...
//
    ...
    public static void TakeScreenShot(WebDriver driver, String fileName) throws IOException {
        ...
        FileUtils.copyFile(image,new File("src/main/resources\\"+fileName+".png"));
    }
...
//        File image = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
//        FileUtils.copyFile(image,new File("C:\\Users\\Admin\\IdeaProjects\\Unit5\\ImageTestScreenShot.png"));
